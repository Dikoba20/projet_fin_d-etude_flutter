...
class OtpPage extends StatefulWidget {
  ...
  final String? otpDebug; // ← UNIQUEMENT EN DEV - à supprimer en production
  const OtpPage({super.key, required this.telephone, this.otpDebug});
  @override
...
class _OtpPageState extends State<OtpPage> {
  ...
  void initState() {
    super.initState();
    // Auto-remplir les cases OTP en mode dev
  ...
  void _verifier() async {
    ...
    try {
      final res = await _authService.verifierOtp(
  ...
  void _renvoyer() async {
    try {
      final res = await _authService.renvoyerOtp(widget.telephone);
      if (!mounted) return;
      // Afficher le nouveau OTP en dev
