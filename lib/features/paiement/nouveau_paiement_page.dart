...
const _apps = [
  _AppBancaire(key: 'bankily', label: 'Bankily', desc: 'Banque Populaire de Mauritanie',
    color: Color(0xFF16A34A), colorLight: Color(0xFFDCFCE7), icon: Icons.account_balance_wallet_rounded,
  ...
  _AppBancaire(key: 'masrvi', label: 'Masrvi', desc: 'Paiement mobile mauritanien',
    color: Color(0xFF1A56DB), colorLight: Color(0xFFDBEAFE), icon: Icons.phone_android_rounded,
  ...
  _AppBancaire(key: 'sedad', label: 'Sedad', desc: "Banque d'investissement mauritanienne",
    color: Color(0xFF166534), colorLight: Color(0xFFDCFCE7), icon: Icons.credit_card_rounded,
  ...
  _AppBancaire(key: 'bimbank', label: 'Bimbank', desc: 'Banque Islamique de Mauritanie',
    color: Color(0xFF1E3A5F), colorLight: Color(0xFFDBEAFE), icon: Icons.account_balance_rounded,
  ...
  _AppBancaire(key: 'click', label: 'Click', desc: 'Banque Nationale de Mauritanie',
    color: Color(0xFF0E7490), colorLight: Color(0xFFE0F2FE), icon: Icons.touch_app_rounded,
...
Widget _logoWidget(_AppBancaire app, {double size = 40, double iconSize = 20}) {
  return ClipRRect(
    ...
    child: Image.network(app.logoUrl, width: size, height: size, fit: BoxFit.contain,
      loadingBuilder: (context, child, loadingProgress) {
        if (loadingProgress == null) return child;
        return SizedBox(width: size, height: size, child: Center(child: CircularProgressIndicator(strokeWidth: 2, color: app.color,
...
class _NouveauPaiementPageState extends State<NouveauPaiementPage> {
  ...
  void initState() {
    super.initState();
    if (widget.contratInitial != null) { _contrat = widget.contratInitial; _etape = 2; }
  }
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Column(children: [
      ...
      Expanded(child: SingleChildScrollView(padding: const EdgeInsets.all(16), child: _contenu())),
    ]),
  );
  ...
  Widget _header(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        GestureDetector(
          onTap: () { if (_etape > 1 && _etape < 4) setState(() => _etape--); else Navigator.pop(context, _etape == 4); },
      ...
      child: Row(children: List.generate(etapes.length, (i) {
        ...
        return Expanded(child: Row(children: [
          Container(width: 28, height: 28,
            ...
            child: Center(child: fait ? const Icon(Icons.check, color: Colors.white, size: 14)
...
class _StepContratState extends State<_StepContrat> {
  ...
  Future<void> _charger() async {
    try {
      ...
      setState(() { _contrats = (liste as List).where((c) => c['statut'] == 'EN_ATTENTE').toList(); _loading = false; });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_erreur != null) return Container(
      ...
      child: Row(children: [
        const Icon(Icons.wifi_off, color: _orange), const SizedBox(width: 12),
    ...
    if (_contrats.isEmpty) return Container(
      ...
      child: const Column(children: [
        Icon(Icons.check_circle_outline, color: _vert, size: 48), SizedBox(height: 12),
...
class _StepMethode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(decoration: BoxDecoration(color: _blueLight, borderRadius: BorderRadius.circular(16)), padding: const EdgeInsets.all(16),
        child: Row(children: [
          Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: _bleu2.withOpacity(0.15), borderRadius: BorderRadius.circular(12)),
            ...
            child: AnimatedContainer(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  if (sel) Container(width: 20, height: 20, decoration: BoxDecoration(color: app.color, shape: BoxShape.circle),
      ...
      SizedBox(width: double.infinity, child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(backgroundColor: _bleu2, disabledBackgroundColor: _grayLight, foregroundColor: Colors.white,
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Container(
      ...
      child: Column(children: [
        Container(width: 72, height: 72, padding: const EdgeInsets.all(8),
    ...
    TextField(
      controller: widget.telCtrl, keyboardType: TextInputType.phone,
    ...
    const SizedBox(height: 12),
    Container(decoration: BoxDecoration(color: widget.app.colorLight, borderRadius: BorderRadius.circular(12)), padding: const EdgeInsets.all(14),
      child: Row(children: [
        Icon(Icons.sms_rounded, color: widget.app.color, size: 18), const SizedBox(width: 10),
    ...
    if (widget.erreur != null) ...[
      const SizedBox(height: 12),
      Container(decoration: BoxDecoration(color: const Color(0xFFFEE2E2), borderRadius: BorderRadius.circular(12)), padding: const EdgeInsets.all(14),
        child: Row(children: [
          const Icon(Icons.error_outline, color: _rouge, size: 18), const SizedBox(width: 10),
    ...
    SizedBox(width: double.infinity, child: ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(backgroundColor: widget.app.color, disabledBackgroundColor: _grayLight, foregroundColor: Colors.white,
          padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)), elevation: 0),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Container(width: 90, height: 90,
        decoration: BoxDecoration(color: _vertLight, shape: BoxShape.circle, boxShadow: [BoxShadow(color: _vertLight, spreadRadius: 12)]),
      ...
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            SizedBox(width: 20, height: 20, child: ClipOval(child: Image.network(widget.app.logoUrl, fit: BoxFit.contain,
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Row(children: [
            Icon(Icons.picture_as_pdf, color: _violet, size: 22), SizedBox(width: 8),
          ...
          Container(decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(12)), padding: const EdgeInsets.all(14),
            child: Row(children: [
              Container(width: 58, height: 58, decoration: BoxDecoration(color: _bleu1, borderRadius: BorderRadius.circular(8)),
                child: GridView.count(crossAxisCount: 3, padding: const EdgeInsets.all(5), crossAxisSpacing: 3, mainAxisSpacing: 3,
                  physics: const NeverScrollableScrollPhysics(),
                  children: List.generate(9, (i) => Container(
                    decoration: BoxDecoration(color: [0,2,4,6,8].contains(i) ? _bleu1 : Colors.white, borderRadius: BorderRadius.circular(2)))))),
              const SizedBox(width: 14),
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(width: double.infinity, child: ElevatedButton.icon(
            ...
            icon: _downloadLoading ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
      ...
      SizedBox(width: double.infinity, child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(backgroundColor: _bleu2, foregroundColor: Colors.white,
            padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)), elevation: 0),
